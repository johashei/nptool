...
G4double menate_R::GetXSInterpolation(G4double KinEng, G4double LowEng, G4double HighEng, G4double LowXS,
                                      G4double HighXS) {
...
G4ThreeVector menate_R::GenMomDir(G4ThreeVector MomDirIn, G4double theta, G4double phi) {
  ...
  if (CONS > 1e-8) {
    ...
    MomDirOut[0] = (SinTh * CosPh * MomDirIn[0] * MomDirIn[2] / CONS) + (SinTh * SinPh * MomDirIn[1] / CONS) +
                   (CosTh * MomDirIn[0]);
    MomDirOut[1] = (SinTh * CosPh * MomDirIn[1] * MomDirIn[2] / CONS) - (SinTh * SinPh * MomDirIn[0] / CONS) +
                   (CosTh * MomDirIn[1]);
...
G4double menate_R::NC12_DIFF(G4double NEng) {
  ...
  if (NEng >= 70. * MeV) {
    FitParam = 0.021613 * NEng - 0.90484;
  } // Fit to AngDist Data
...
void menate_R::Setup_AlElastic_AngDist() {
  ...
  // 30MeV-------
  double dist_30[num] = {
      -1.000000 + 0, 1.143092e-2,  -9.990482e-1, 1.124223e-2,  -9.961947e-1, 1.069678e-2,  -9.914449e-1, 9.853178e-3,
      -9.848078e-1,  8.801133e-3,  -9.762960e-1, 7.649630e-3,  -9.659258e-1, 6.513742e-3,  -9.537170e-1, 5.500872e-3,
      -9.396926e-1,  4.698089e-3,  -9.238795e-1, 4.163449e-3,  -9.063078e-1, 3.920835e-3,  -8.870108e-1, 3.959841e-3,
      -8.660254e-1,  4.239958e-3,  -8.433914e-1, 4.698323e-3,  -8.191520e-1, 5.259733e-3,  -7.933533e-1, 5.847400e-3,
      -7.660444e-1,  6.392955e-3,  -7.372773e-1, 6.844546e-3,  -7.071068e-1, 7.172467e-3,  -6.755902e-1, 7.371493e-3,
      -6.427876e-1,  7.460832e-3,  -6.087614e-1, 7.481616e-3,  -5.735764e-1, 7.493423e-3,  -5.372996e-1, 7.569377e-3,
      -5.000000e-1,  7.791201e-3,  -4.617486e-1, 8.243935e-3,  -4.226183e-1, 9.009845e-3,  -3.826834e-1, 1.016157e-2,
      -3.420201e-1,  1.175351e-2,  -3.007058e-1, 1.381233e-2,  -2.588190e-1, 1.632611e-2,  -2.164396e-1, 1.923550e-2,
      -1.736482e-1,  2.242820e-2,  -1.305262e-1, 2.574168e-2,  -8.715574e-2, 2.897774e-2,  -4.361939e-2, 3.193267e-2,
      0.000000 + 0,  3.444537e-2,  4.361939e-2,  3.646164e-2,  8.715574e-2,  3.811006e-2,  1.305262e-1,  3.977790e-2,
      1.736482e-1,   4.217155e-2,  2.164396e-1,  4.633969e-2,  2.588190e-1,  5.363686e-2,  3.007058e-1,  6.560642e-2,
      3.420201e-1,   8.376855e-2,  3.826834e-1,  1.093183e-1,  4.226183e-1,  1.427545e-1,  4.617486e-1,  1.834979e-1,
      5.000000e-1,   2.295749e-1,  5.372996e-1,  2.774898e-1,  5.735764e-1,  3.224090e-1,  6.087614e-1,  3.587789e-1,
      6.427876e-1,   3.814766e-1,  6.755902e-1,  3.875034e-1,  7.071068e-1,  3.781310e-1,  7.372773e-1,  3.612692e-1,
      7.660444e-1,   3.536586e-1,  7.933533e-1,  3.823776e-1,  8.191520e-1,  4.850586e-1,  8.433914e-1,  7.082584e-1,
      8.660254e-1,   1.103586 + 0, 8.870108e-1,  1.721515 + 0, 9.063078e-1,  2.603299 + 0, 9.238795e-1,  3.771875 + 0,
      9.396926e-1,   5.223208 + 0, 9.537170e-1,  6.919739 + 0, 9.659258e-1,  8.787858 + 0, 9.762960e-1,  1.072018 + 1,
      9.848078e-1,   1.258416 + 1, 9.914449e-1,  1.423525 + 1, 9.961947e-1,  1.553436 + 1, 9.990482e-1,  1.636534 + 1,
  ...
  // 50MeV-----
  double dist_50[num] = {
      -1.000000 + 0, 6.709124e-4,  -9.990482e-1, 6.603906e-4,  -9.961947e-1, 6.304766e-4,  -9.914449e-1, 5.858351e-4,
      -9.848078e-1,  5.332814e-4,  -9.762960e-1, 4.805843e-4,  -9.659258e-1, 4.350849e-4,  -9.537170e-1, 4.024467e-4,
      -9.396926e-1,  3.857654e-4,  -9.238795e-1, 3.852123e-4,  -9.063078e-1, 3.982495e-4,  -8.870108e-1, 4.203689e-4,
      -8.660254e-1,  4.461890e-4,  -8.433914e-1, 4.707079e-4,  -8.191520e-1, 4.904874e-4,  -7.933533e-1, 5.045640e-4,
      -7.660444e-1,  5.149420e-4,  -7.372773e-1, 5.265894e-4,  -7.071068e-1, 5.469609e-4,  -6.755902e-1, 5.851284e-4,
      -6.427876e-1,  6.506459e-4,  -6.087614e-1, 7.522636e-4,  -5.735764e-1, 8.966486e-4,  -5.372996e-1, 1.087158e-3,
      -5.000000e-1,  1.322876e-3,  -4.617486e-1, 1.598021e-3,  -4.226183e-1, 1.902000e-3,  -3.826834e-1, 2.220344e-3,
      -3.420201e-1,  2.536745e-3,  -3.007058e-1, 2.836444e-3,  -2.588190e-1, 3.110933e-3,  -2.164396e-1, 3.363524e-3,
      -1.736482e-1,  3.614936e-3,  -1.305262e-1, 3.907434e-3,  -8.715574e-2, 4.305532e-3,  -4.361939e-2, 4.891377e-3,
      0.000000 + 0,  5.753370e-3,  4.361939e-2,  6.967889e-3,  8.715574e-2,  8.576699e-3,  1.305262e-1,  1.056473e-2,
      1.736482e-1,   1.284832e-2,  2.164396e-1,  1.528370e-2,  2.588190e-1,  1.770778e-2,  3.007058e-1,  2.001875e-2,
      3.420201e-1,   2.229245e-2,  3.826834e-1,  2.491798e-2,  4.226183e-1,  2.871318e-2,  4.617486e-1,  3.496300e-2,
      5.000000e-1,   4.531408e-2,  5.372996e-1,  6.146544e-2,  5.735764e-1,  8.463770e-2,  6.087614e-1,  1.148850e-1,
      6.427876e-1,   1.504327e-1,  6.755902e-1,  1.873634e-1,  7.071068e-1,  2.201177e-1,  7.372773e-1,  2.432984e-1,
      7.660444e-1,   2.551966e-1,  7.933533e-1,  2.630871e-1,  8.191520e-1,  2.897874e-1,  8.433914e-1,  3.801505e-1,
      8.660254e-1,   6.053457e-1,  8.870108e-1,  1.062217 + 0, 9.063078e-1,  1.865062 + 0, 9.238795e-1,  3.128298 + 0,
      9.396926e-1,   4.940641 + 0, 9.537170e-1,  7.334422 + 0, 9.659258e-1,  1.025697 + 1, 9.762960e-1,  1.355285 + 1,
      9.848078e-1,   1.696543 + 1, 9.914449e-1,  2.016259 + 1, 9.961947e-1,  2.278521 + 1, 9.990482e-1,  2.450986 + 1,
  ...
  // 70MeV-----
  double dist_70[num] = {
      -1.000000 + 0, 3.282137e-6,  -9.990482e-1, 3.320258e-6,  -9.961947e-1, 3.435988e-6,  -9.914449e-1, 3.627566e-6,
      -9.848078e-1,  3.879130e-6,  -9.762960e-1, 4.156161e-6,  -9.659258e-1, 4.410307e-6,  -9.537170e-1, 4.586605e-6,
      -9.396926e-1,  4.627784e-6,  -9.238795e-1, 4.480618e-6,  -9.063078e-1, 4.114588e-6,  -8.870108e-1, 3.553527e-6,
      -8.660254e-1,  2.905423e-6,  -8.433914e-1, 2.372443e-6,  -8.191520e-1, 2.238375e-6,  -7.933533e-1, 2.843672e-6,
      -7.660444e-1,  4.551534e-6,  -7.372773e-1, 7.691386e-6,  -7.071068e-1, 1.246622e-5,  -6.755902e-1, 1.883831e-5,
      -6.427876e-1,  2.643986e-5,  -6.087614e-1, 3.455596e-5,  -5.735764e-1, 4.220604e-5,  -5.372996e-1, 4.833323e-5,
      -5.000000e-1,  5.212627e-5,  -4.617486e-1, 5.349607e-5,  -4.226183e-1, 5.366340e-5,  -3.826834e-1, 5.568937e-5,
      -3.420201e-1,  6.468955e-5,  -3.007058e-1, 8.747101e-5,  -2.588190e-1, 1.314276e-4,  -2.164396e-1, 2.026794e-4,
      -1.736482e-1,  3.036667e-4,  -1.305262e-1, 4.308042e-4,  -8.715574e-2, 5.733049e-4,  -4.361939e-2, 7.146489e-4,
      0.000000 + 0,  8.379677e-4,  4.361939e-2,  9.356725e-4,  8.715574e-2,  1.021972e-3,  1.305262e-1,  1.144510e-3,
      1.736482e-1,   1.389505e-3,  2.164396e-1,  1.873184e-3,  2.588190e-1,  2.714392e-3,  3.007058e-1,  3.989167e-3,
      3.420201e-1,   5.679383e-3,  3.826834e-1,  7.640669e-3,  4.226183e-1,  9.625927e-3,  4.617486e-1,  1.139963e-2,
      5.000000e-1,   1.295828e-2,  5.372996e-1,  1.482605e-2,  5.735764e-1,  1.832085e-2,  6.087614e-1,  2.561511e-2,
      6.427876e-1,   3.937859e-2,  6.755902e-1,  6.185808e-2,  7.071068e-1,  9.347093e-2,  7.372773e-1,  1.313941e-1,
      7.660444e-1,   1.691515e-1,  7.933533e-1,  1.987067e-1,  8.191520e-1,  2.166963e-1,  8.433914e-1,  2.358658e-1,
      8.660254e-1,   3.010805e-1,  8.870108e-1,  5.064869e-1,  9.063078e-1,  1.006997 + 0, 9.238795e-1,  2.014608 + 0,
      9.396926e-1,   3.770019 + 0, 9.537170e-1,  6.484900 + 0, 9.659258e-1,  1.026029 + 1, 9.762960e-1,  1.500126 + 1,
      9.848078e-1,   2.035945 + 1, 9.914449e-1,  2.573888 + 1, 9.961947e-1,  3.038484 + 1, 9.990482e-1,  3.354666 + 1,
...
void menate_R::Setup_FeElastic_AngDist() {
  ...
  // 30MeV-------
  double dist_30[num] = {
      -1.000000e+0, 6.864330e-2, -9.990482e-1, 6.799924e-2, -9.961947e-1, 6.606658e-2, -9.914449e-1, 6.285744e-2,
      -9.848078e-1, 5.841792e-2, -9.762960e-1, 5.286584e-2, -9.659258e-1, 4.642469e-2, -9.537170e-1, 3.944496e-2,
      -9.396926e-1, 3.240171e-2, -9.238795e-1, 2.585606e-2, -9.063078e-1, 2.038231e-2, -8.870108e-1, 1.646921e-2,
      -8.660254e-1, 1.441510e-2, -8.433914e-1, 1.424461e-2, -8.191520e-1, 1.567324e-2, -7.933533e-1, 1.813968e-2,
      -7.660444e-1, 2.090887e-2, -7.372773e-1, 2.322993e-2, -7.071068e-1, 2.451358e-2, -6.755902e-1, 2.448392e-2,
      -6.427876e-1, 2.326010e-2, -6.087614e-1, 2.133853e-2, -5.735764e-1, 1.947210e-2, -5.372996e-1, 1.847261e-2,
      -5.000000e-1, 1.898707e-2, -4.617486e-1, 2.130970e-2, -4.226183e-1, 2.528576e-2, -3.826834e-1, 3.033819e-2,
      -3.420201e-1, 3.561518e-2, -3.007058e-1, 4.022124e-2, -2.588190e-1, 4.346884e-2, -2.164396e-1, 4.508347e-2,
      -1.736482e-1, 4.530519e-2, -1.305262e-1, 4.486399e-2, -8.715574e-2, 4.483712e-2, -4.361939e-2, 4.643046e-2,
      0.000000e+0,  5.073712e-2, 4.361939e-2,  5.852223e-2, 8.715574e-2,  7.006881e-2, 1.305262e-1,  8.508392e-2,
      1.736482e-1,  1.026739e-1, 2.164396e-1,  1.213783e-1, 2.588190e-1,  1.392980e-1, 3.007058e-1,  1.543629e-1,
      3.420201e-1,  1.647997e-1, 3.826834e-1,  1.698153e-1, 4.226183e-1,  1.704198e-1, 4.617486e-1,  1.701846e-1,
      5.000000e-1,  1.755779e-1, 5.372996e-1,  1.954684e-1, 5.735764e-1,  2.394566e-1, 6.087614e-1,  3.149690e-1,
      6.427876e-1,  4.235233e-1, 6.755902e-1,  5.571453e-1, 7.071068e-1,  6.964176e-1, 7.372773e-1,  8.118647e-1,
      7.660444e-1,  8.699422e-1, 7.933533e-1,  8.440213e-1, 8.191520e-1,  7.290353e-1, 8.433914e-1,  5.566144e-1,
      8.660254e-1,  4.061517e-1, 8.870108e-1,  4.064349e-1, 9.063078e-1,  7.237915e-1, 9.238795e-1,  1.535223e+0,
      9.396926e-1,  2.989307e+0, 9.537170e-1,  5.162009e+0, 9.659258e-1,  8.018149e+0, 9.762960e-1,  1.139005e+1,
      9.848078e-1,  1.498265e+1, 9.914449e-1,  1.840853e+1, 9.961947e-1,  2.124884e+1, 9.990482e-1,  2.312784e+1,
  ...
  // 50MeV-----
  double dist_50[num] = {
      -1.000000e+0, 3.691942e-3, -9.990482e-1, 3.578426e-3, -9.961947e-1, 3.262122e-3, -9.914449e-1, 2.808433e-3,
      -9.848078e-1, 2.304621e-3, -9.762960e-1, 1.835324e-3, -9.659258e-1, 1.461301e-3, -9.537170e-1, 1.208336e-3,
      -9.396926e-1, 1.068867e-3, -9.238795e-1, 1.014110e-3, -9.063078e-1, 1.010602e-3, -8.870108e-1, 1.034141e-3,
      -8.660254e-1, 1.076051e-3, -8.433914e-1, 1.140557e-3, -8.191520e-1, 1.236001e-3, -7.933533e-1, 1.364980e-3,
      -7.660444e-1, 1.518547e-3, -7.372773e-1, 1.677278e-3, -7.071068e-1, 1.818750e-3, -6.755902e-1, 1.928005e-3,
      -6.427876e-1, 2.006146e-3, -6.087614e-1, 2.073045e-3, -5.735764e-1, 2.162751e-3, -5.372996e-1, 2.313195e-3,
      -5.000000e-1, 2.554042e-3, -4.617486e-1, 2.896975e-3, -4.226183e-1, 3.331733e-3, -3.826834e-1, 3.829010e-3,
      -3.420201e-1, 4.349491e-3, -3.007058e-1, 4.856640e-3, -2.588190e-1, 5.330337e-3, -2.164396e-1, 5.777631e-3,
      -1.736482e-1, 6.238028e-3, -1.305262e-1, 6.779185e-3, -8.715574e-2, 7.482344e-3, -4.361939e-2, 8.417194e-3,
      0.000000e+0,  9.613124e-3, 4.361939e-2,  1.103728e-2, 8.715574e-2,  1.259760e-2, 1.305262e-1,  1.418379e-2,
      1.736482e-1,  1.574889e-2, 2.164396e-1,  1.740999e-2, 2.588190e-1,  1.951995e-2, 3.007058e-1,  2.264527e-2,
      3.420201e-1,  2.739634e-2, 3.826834e-1,  3.411133e-2, 4.226183e-1,  4.249017e-2, 4.617486e-1,  5.138349e-2,
      5.000000e-1,  5.900207e-2, 5.372996e-1,  6.375657e-2, 5.735764e-1,  6.569038e-2, 6.087614e-1,  6.807300e-2,
      6.427876e-1,  7.826655e-2, 6.755902e-1,  1.067589e-1, 7.071068e-1,  1.635344e-1, 7.372773e-1,  2.520196e-1,
      7.660444e-1,  3.625788e-1, 7.933533e-1,  4.694480e-1, 8.191520e-1,  5.360762e-1, 8.433914e-1,  5.328226e-1,
      8.660254e-1,  4.670148e-1, 8.870108e-1,  4.188167e-1, 9.063078e-1,  5.690737e-1, 9.238795e-1,  1.200984e+0,
      9.396926e-1,  2.659844e+0, 9.537170e-1,  5.266500e+0, 9.659258e-1,  9.198724e+0, 9.762960e-1,  1.437487e+1,
      9.848078e-1,  2.038495e+1, 9.914449e-1,  2.650916e+1, 9.961947e-1,  3.183898e+1, 9.990482e-1,  3.547902e+1,
  ...
  // 70MeV-----
  double dist_70[num] = {
      -1.000000e+0, 1.983425e-6, -9.990482e-1, 1.965798e-6, -9.961947e-1, 1.905855e-6, -9.914449e-1, 1.789217e-6,
      -9.848078e-1, 1.608414e-6, -9.762960e-1, 1.374194e-6, -9.659258e-1, 1.121800e-6, -9.537170e-1, 9.156061e-7,
      -9.396926e-1, 8.487982e-7, -9.238795e-1, 1.028369e-6, -9.063078e-1, 1.543452e-6, -8.870108e-1, 2.426820e-6,
      -8.660254e-1, 3.620830e-6, -8.433914e-1, 4.955293e-6, -8.191520e-1, 6.152640e-6, -7.933533e-1, 6.884876e-6,
      -7.660444e-1, 6.894530e-6, -7.372773e-1, 6.152684e-6, -7.071068e-1, 5.003299e-6, -6.755902e-1, 4.240556e-6,
      -6.427876e-1, 5.065765e-6, -6.087614e-1, 8.855034e-6, -5.735764e-1, 1.670012e-5, -5.372996e-1, 2.880136e-5,
      -5.000000e-1, 4.395150e-5, -4.617486e-1, 5.943709e-5, -4.226183e-1, 7.165837e-5, -3.826834e-1, 7.762420e-5,
      -3.420201e-1, 7.715392e-5, -3.007058e-1, 7.507574e-5, -2.588190e-1, 8.212670e-5, -2.164396e-1, 1.131184e-4,
      -1.736482e-1, 1.816766e-4, -1.305262e-1, 2.925482e-4, -8.715574e-2, 4.346801e-4, -4.361939e-2, 5.800715e-4,
      0.000000e+0,  6.933060e-4, 4.361939e-2,  7.530309e-4, 8.715574e-2,  7.790938e-4, 1.305262e-1,  8.502975e-4,
      1.736482e-1,  1.093673e-3, 2.164396e-1,  1.633476e-3, 2.588190e-1,  2.510481e-3, 3.007058e-1,  3.613760e-3,
      3.420201e-1,  4.690171e-3, 3.826834e-1,  5.484783e-3, 4.226183e-1,  5.996965e-3, 4.617486e-1,  6.725686e-3,
      5.000000e-1,  8.681963e-3, 5.372996e-1,  1.297100e-2, 5.735764e-1,  1.997476e-2, 6.087614e-1,  2.857775e-2,
      6.427876e-1,  3.626075e-2, 6.755902e-1,  4.084107e-2, 7.071068e-1,  4.379671e-2, 7.372773e-1,  5.349841e-2,
      7.660444e-1,  8.508892e-2, 7.933533e-1,  1.537562e-1, 8.191520e-1,  2.613914e-1, 8.433914e-1,  3.833791e-1,
      8.660254e-1,  4.699469e-1, 8.870108e-1,  4.791521e-1, 9.063078e-1,  4.493164e-1, 9.238795e-1,  5.943887e-1,
      9.396926e-1,  1.373549e+0, 9.537170e-1,  3.465226e+0, 9.659258e-1,  7.589794e+0, 9.762960e-1,  1.418895e+1,
      9.848078e-1,  2.306574e+1, 9.914449e-1,  3.316772e+1, 9.961947e-1,  4.268799e+1, 9.990482e-1,  4.953558e+1,
...
G4double menate_R::AlElastic_AngDist(G4double NEng) {
  ...
  if (NEng <= 15 * MeV)
    ang_CM = G4UniformRand();
  else if (NEng <= 40 * MeV)
    ang_CM = hAl_AngDist_30MeV->GetRandom();
  else if (NEng <= 60 * MeV)
    ang_CM = hAl_AngDist_50MeV->GetRandom();
  else if (NEng > 60 * MeV)
    ang_CM = hAl_AngDist_70MeV->GetRandom();
...
G4double menate_R::FeElastic_AngDist(G4double NEng) {
  ...
  if (NEng <= 15 * MeV)
    ...
    ang_CM = hFe_AngDist_30MeV->GetRandom();
  else if (NEng <= 60 * MeV)
    ang_CM = hFe_AngDist_50MeV->GetRandom();
  else if (NEng > 60 * MeV)
    ang_CM = hFe_AngDist_70MeV->GetRandom();
...
G4double menate_R::GetMeanFreePath(const G4Track& aTrack, G4double, // previousStepSize,
  ...
  *condition = NotForced;
  ...
  for (G4int ne = 0; ne < NumberOfElements; ne++) {
    auto theElement = (*theElementList)[ne];
...
G4VParticleChange* menate_R::PostStepDoIt(const G4Track& aTrack, const G4Step& aStep) {
  ...
  */
  ...
  // zwk modification  Bool_t fwrdANGLES = true means use cos_theta_iso=pow(G4uniformRand,1/4), so becomes very forward
  // focused rather than isotropic
  ...
  if (ReactionName == "N_P_elastic") {
    ...
    if (KinEng_Int >= 8.5 * MeV) {
      Available_Eng = 8.5 * MeV * (G4UniformRand());
    } // Max available Eng = 8.5 MeV ?
    else {
    ...
    if (KinEng_Int >= 4.5 * MeV)
      enough_gamma_eng = 5.0 * MeV;
    ...
    if (Available_Eng <= 0.) {
      Available_Eng = 0.;
    } // = 0 in Fortran code - BTR

    G4double cos_theta_iso = 1. - (2. * G4UniformRand());
    // zwk
    if (fwrdANGLES)
      cos_theta_iso = pow(G4UniformRand(), 1. / 4.0);

    G4double T_N =
        KinEng_Int / 169. + 0.9230769 * Available_Eng + (0.1478106 * sqrt(KinEng_Int * Available_Eng)) * cos_theta_iso;
    ...
    G4cout << "p1, px: " << vec1.x()/MeV << "  py: " << vec1.y()/MeV << " pz: " << vec1.z()/MeV << "  mag: " <<
    vec1.mag()/MeV << G4endl; G4cout << "  Total Mom: " << p1 ->GetTotalMomentum()/MeV << "  TotalE: " <<
    p1->GetTotalEnergy()/MeV << "  KE: " << p1->GetKineticEnergy()/MeV << G4endl;


    G4DynamicParticle *p2 = (G4DynamicParticle*) theAlphaTrack->GetDynamicParticle();
    G4ThreeVector vec2 = p2->GetMomentum();
    G4cout << "p2, px: " << vec2.x()/MeV << "  py: " << vec2.y()/MeV << " pz: " << vec2.z()/MeV << "  mag: " <<
    vec2.mag()/MeV << G4endl; G4cout << "  Total Mom: " << p2->GetTotalMomentum()/MeV << "  TotalE: " <<
    p2->GetTotalEnergy()/MeV << "  KE: " << p2->GetKineticEnergy()/MeV << G4endl;


    G4DynamicParticle *p3 = (G4DynamicParticle*) theBe9Track->GetDynamicParticle();
    G4ThreeVector vec3 = p3->GetMomentum();
    G4cout << "p3, px: " << vec3.x()/MeV << "  py: " << vec3.y()/MeV << " pz: " << vec3.z()/MeV << "  mag: " <<
    vec3.mag()/MeV << G4endl; G4cout << "  Total Mom: " << p3->GetTotalMomentum()/MeV << "  TotalE: " <<
    p3->GetTotalEnergy()/MeV << "  KE: " << p3->GetKineticEnergy()/MeV << G4endl;
    //-----------
    */
    ...
    G4double T_P =
        T_C12Star / 12. + 0.9166667 * Available_Eng + (0.5527708 * sqrt(Available_Eng * T_C12Star)) * cos_theta_iso;
    ...
    G4double T_N2 = T_C12Star / 12. + Eng_Evap2 + (0.5773503 * sqrt(T_C12Star * Eng_Evap2)) * cos_theta_iso;
    ...
    */
    ...
    G4double T_Alpha1 =
        T_C12Star / 3. + 0.6666667 * Available_Eng + (0.9428090 * sqrt(Available_Eng * T_C12Star)) * cos_theta_iso;
    ...
    if (T_Be8Star > 1.e-5) {
      ...
      G4double Arg =
          (0.8164966 * sqrt(T_C12Star) - (0.5773503 * sqrt(Available_Eng) * cos_theta_iso)) / (sqrt(T_Be8Star));
      if (Arg > 1.) {
        Arg = 1.;
      }
    ...
    G4double T_Alpha2 = 0.5 * (T_Be8Star + Available_Eng) + (sqrt(Available_Eng * T_Be8Star)) * cos_theta_iso;
    if (T_Alpha2 < 0.) {
      T_Alpha2 = 1e-9;
    }
    ...
    G4cout << "A1 = " << T_Alpha1 << " ,A2 = " << T_Alpha2 << " , A3 = " << T_Alpha3 << ", A_Sum = " << T_A_Sum <<
    G4endl; G4cout << "Total Eng Final State : " << T_A_Sum+T_N << " , Eng_Int-Qvalue = " << KinEng_Int-7.275+0.092 <<
    G4endl;
    */
    // G4cout << "Made it to the end ! " << G4endl;
  }
  ...
  theta_N = acos(arg);
    ...
    */
    ...
    // G4cout << "Al theta: " << cos_theta_cm << " " << theta_cm << " " << cos_theta_lab_Al << " " << theta_lab_Al <<
    // G4endl; G4cout << "Al KE: " << T_Al/MeV << " Init_N KE: " << KinEng_Int/MeV << G4endl;
